...
** TODO adding value to our data to answer a question
...
* 5.1: R in the newsroom: ggplot
  from session: https://github.com/basilesimon/interactive-journalism-module/blob/archive/2016-2017/week6/week6.md
  and
